...
export default function Navbar({ onOpenSettings, onOpenExport, onReset, hasApiKey }) {
  return (
    <header className="sticky top-0 z-30 w-full px-4 sm:px-8 py-3 bg-white/95 backdrop-blur-md border-b border-stone-200/90 shadow-sm">
      <div className="max-w-[1600px] mx-auto flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-2.5">
              <h1 className="text-base sm:text-lg font-bold text-stone-900 font-display tracking-tight">
                PinDou Atelier
              </h1>
            ...
            <p className="text-xs text-stone-400 hidden sm:block font-normal">
        ...
        <div className="flex items-center gap-2 sm:gap-2.5">
          ...
          <button
            onClick={onReset}
            className="p-2 rounded-xl bg-stone-50 hover:bg-rose-50 border border-stone-200 text-stone-500 hover:text-rose-600 transition-colors"
            title="清空画布"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-1.5 rounded-xl bg-stone-900 hover:bg-stone-800 text-white text-xs sm:text-sm font-medium shadow-sm transition-all active:scale-95 ml-1"
          >
